...
def user_page():   
    if request.method == 'GET': 
        ...
        return render_template("userpage.html", myreview_query=query,username=username, user_id=user_id,favorite_titles=favorite_titles,follow_data=follow_data,result=result, combined_list=combined_list, genre_choice=genre_choice, logged_in=logged_in,follow_num=follow_num)
